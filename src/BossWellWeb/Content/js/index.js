...
function GetLoadNav() {
    ...
    $.each(data, function (i) {
        ...
        if (row.ParentId == "0") {
            _html += '<li>';
            _html += '<a data-id="' + row.Sid + '" href="#" class="dropdown-toggle"><i class="' + row.Icon + '"></i><span>' + row.FullName + '</span><i class="fa fa-angle-right drop-icon"></i></a>';
            ...
            if (childNodes.length > 0) {
                ...
                $.each(childNodes, function (i) {
                    ...
                    _html += '<li>';
                    _html += '<a class="menuItem" data-id="' + subrow.Sid + '" href="' + subrow.Path + '" data-index="' + subrow.Sort + '">' + subrow.FullName + '</a>';
                    _html += '</li>';
                });
                _html += '</ul>';
            }
