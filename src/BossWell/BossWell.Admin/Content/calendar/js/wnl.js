...
(function (e, t) {
    function i(t, n) {
        ...
        return "area" === u ? (r = t.parentNode, i = r.name, !t.href || !i || r.nodeName.toLowerCase()
            !== "map" ? !1 : (o = e("img[usemap=#" + i + "]")[0], !!o && s(o))) :
            (/input|select|textarea|button|object/.test(u) ? !t.disabled : "a" === u ? t.href || n : n) && s(t)
    } function s(t) {
        return e.expr.filters.visible(t) && !e(t).parents().addBack().filter(function () {
            return e.css(this, "visibility") === "hidden"
        }).length
    } var n = 0, r = /^ui-id-\d+$/; e.ui = e.ui || {}, e.extend(e.ui, {
        version: "1.10.3", keyCode: {
            BACKSPACE: 8, COMMA: 188, DELETE: 46, DOWN: 40, END: 35, ENTER: 13,
            ESCAPE: 27, HOME: 36, LEFT: 37, NUMPAD_ADD: 107, NUMPAD_DECIMAL: 110, NUMPAD_DIVIDE: 111,
            NUMPAD_ENTER: 108, NUMPAD_MULTIPLY: 106, NUMPAD_SUBTRACT: 109, PAGE_DOWN: 34, PAGE_UP: 33,
            PERIOD: 190, RIGHT: 39, SPACE: 32, TAB: 9, UP: 38
        }
    }), e.fn.extend({
        focus: function (t) {
            return function (n, r) {
                return typeof n == "number" ? this.each(function () {
                    var t = this; setTimeout(function () { e(t).focus(), r && r.call(t) }, n)
                }) : t.apply(this, arguments)
            }
        }(e.fn.focus), scrollParent: function () {
            var t; return e.ui.ie && /(static|relative)/.test(this.css("position")) ||
                /absolute/.test(this.css("position")) ? t = this.parents().filter(function () {
                    ...
                    return /(auto|scroll)/.test(e.css(this, "overflow") + e.css(this, "overflow-y") +
                        e.css(this, "overflow-x"))
                }).eq(0), /fixed/.test(this.css("position")) || !t.length ? e(document) : t
        }, zIndex: function (n) {
            if (n !== t) return this.css("zIndex", n); if (this.length) {
                var r = e(this[0]), i, s; while (r.length && r[0] !== document) { i = r.css("position"); if (i === "absolute" || i === "relative" || i === "fixed") { s = parseInt(r.css("zIndex"), 10); if (!isNaN(s) && s !== 0) return s } r = r.parent() }
            } return 0
        }, uniqueId: function () {
        ...
        data: e.expr.createPseudo ? e.expr.createPseudo(function (t) {
            return function (n) { return !!e.data(n, t) }
        }) : function (t, n, r) { return !!e.data(t, r[3]) }, focusable: function (t) {
            return i(t, !isNaN(e.attr(t, "tabindex")))
        }, tabbable: function (t) {
            var n = e.attr(t, "tabindex"), r = isNaN(n); return (r || n >= 0) && i(t, !r)
        }
    }), e("<a>").outerWidth(1).jquery || e.each(["Width", "Height"], function (n, r) {
        function u(t, n, r, s) {
            return e.each(i, function () {
                n -= parseFloat(e.css(t, "padding" + this)) || 0,
                    r && (n -= parseFloat(e.css(t, "border" + this + "Width")) || 0), s &&
                (n -= parseFloat(e.css(t, "margin" + this)) || 0)
            }), n
        } var i = r === "Width" ? ["Left", "Right"] : ["Top", "Bottom"], s = r.toLowerCase(), o = {
            innerWidth: e.fn.innerWidth, innerHeight: e.fn.innerHeight, outerWidth: e.fn.outerWidth,
            outerHeight: e.fn.outerHeight
        }; e.fn["inner" + r] = function (n) {
            return n === t ? o["inner" + r].call(this) : this.each(function () { e(this).css(s, u(this, n) + "px") })
        }, e.fn["outer" + r] = function (t, n) {
            return typeof t != "number" ? o["outer" + r].call(this, t)
                : this.each(function () { e(this).css(s, u(this, t, !0, n) + "px") })
        }
    }), e.fn.addBack || (e.fn.addBack = function (e) {
        return this.add(e == null ? this.prevObject : this.prevObject.filter(e))
    }), e("<a>").data("a-b", "a").removeData("a-b").data("a-b") && (e.fn.removeData = function (t) {
        return function (n) { return arguments.length ? t.call(this, e.camelCase(n)) : t.call(this) }
    ...
    e.support.selectstart = "onselectstart" in document.createElement("div"), e.fn.extend({
        ...
        plugin: {
            add: function (t, n, r) {
                var i, s = e.ui[t].prototype; for (i in r) s.plugins[i] = s.plugins[i] || [], s.plugins[i].push([n, r[i]])
            }, call: function (e, t, n) {
                var r, i = e.plugins[t]; if (!i || !e.element[0].parentNode
                    || e.element[0].parentNode.nodeType === 11) return;
    ...
    e.cleanData = function (t) {
        ...
        t = t.split(".")[1], i = f + "-" + t, r || (r = n, n = e.Widget), e.expr[":"][i.toLowerCase()] =
            function (t) { return !!e.data(t, i) }, e[f] = e[f] || {}, s = e[f][t], o = e[f][t] =
            function (e, t) {
                if (!this._createWidget) return new o(e, t); arguments.length &&
        ...
        u = new n, u.options = e.widget.extend({}, u.options), e.each(r, function (t, r) {
            if (!e.isFunction(r)) {
                ...
                var e = function () { return n.prototype[t].apply(this, arguments) }, i = function (e) {
                    return n.prototype[t].apply(this, e)
                }; return function () { var t = this._super, n = this._superApply, s; return this._super = e, this._superApply = i, s = r.apply(this, arguments), this._super = t, this._superApply = n, s }
            }()
        }), o.prototype = e.widget.extend(u, { widgetEventPrefix: s ? u.widgetEventPrefix : t }, a, { constructor: o, namespace: f, widgetName: t, widgetFullName: i }), s ? (e.each(s._childConstructors, function (t, n) { var r = n.prototype; e.widget(r.namespace + "." + r.widgetName, o, n._proto) }), delete s._childConstructors) : n._childConstructors.push(o), e.widget.bridge(t, o)
    }, e.widget.extend = function (n) {
        var i = r.call(arguments, 1), s = 0, o = i.length, u, a;
        for (; s < o; s++)
        for (u in i[s]) a = i[s][u], i[s].hasOwnProperty(u) &&
            a !== t && (e.isPlainObject(a) ? n[u] = e.isPlainObject(n[u]) ?
            e.widget.extend({}, n[u], a) : e.widget.extend({}, a) : n[u] = a); return n
    }, e.widget.bridge = function (n, i) {
        var s = i.prototype.widgetFullName || n; e.fn[n] = function (o) {
            var u = typeof o == "string", a = r.call(arguments, 1), f = this; return o = !u && a.length
                ? e.widget.extend.apply(null, [o].concat(a)) : o, u ? this.each(function () {
                    var r, i = e.data(this, s); if (!i) return e.error("cannot call methods on " + n +
                        " prior to initialization; " + "attempted to call method '" + o + "'");
                    if (!e.isFunction(i[o]) || o.charAt(0) === "_") return e.error("no such method '" + o + "' for "
                        + n + " widget instance"); r = i[o].apply(i, a); if (r !== i && r !== t)
                            return f = r && r.jquery ? f.pushStack(r.get()) : r, !1
                }) : this.each(function () {
                    var t = e.data(this, s); t ? t.option(o || {})._init() :
        ...
        _createWidget: function (t, r) {
            r = e(r || this.defaultElement || this)[0], this.element = e(r),
                this.uuid = n++, this.eventNamespace = "." + this.widgetName + this.uuid, this.options = e.widget.extend({}, this.options, this._getCreateOptions(), t), this.bindings = e(), this.hoverable = e(), this.focusable = e(), r !== this && (e.data(r, this.widgetFullName, this), this._on(!0, this.element, { remove: function (e) { e.target === r && this.destroy() } }), this.document = e(r.style ? r.ownerDocument : r.document || r), this.window = e(this.document[0].defaultView || this.document[0].parentWindow)), this._create(), this._trigger("create", null, this._getCreateEventData()), this._init()
        ...
        destroy: function () {
            this._destroy(), this.element.unbind(this.eventNamespace).removeData(this.widgetName).
                removeData(this.widgetFullName).removeData(e.camelCase(this.widgetFullName)),
            this.widget().unbind(this.eventNamespace).removeAttr("aria-disabled").removeClass(this.widgetFullName +
                "-disabled " + "ui-state-disabled"), this.bindings.unbind(this.eventNamespace),
            this.hoverable.removeClass("ui-state-hover"), this.focusable.removeClass("ui-state-focus")
        }, _destroy: e.noop, widget: function () { return this.element }, option: function (n, r) {
            var i = n, s, o, u; if (arguments.length === 0) return e.widget.extend({}, this.options);
            if (typeof n == "string") {
                i = {}, s = n.split("."), n = s.shift(); if (s.length) {
                    o = i[n] =
                        e.widget.extend({}, this.options[n]); for (u = 0; u < s.length - 1; u++) o[s[u]] = o[s[u]] || {}, o = o[s[u]]; n = s.pop(); if (r === t) return o[n] === t ? null : o[n]; o[n] = r
                } else {
        ...
        _setOption: function (e, t) {
            return this.options[e] = t, e === "disabled" && (this.widget().toggleClass(this.widgetFullName
                + "-disabled ui-state-disabled", !!t).attr("aria-disabled", t), this.hoverable.removeClass("ui-state-hover"),
                this.focusable.removeClass("ui-state-focus")), this
        }, enable: function () { return this._setOption("disabled", !1) },
        disable: function () {
            return this._setOption("disabled", !0)
        }, _on: function (t, n, r) {
            var i, s = this; typeof t != "boolean" && (r = n, n = t, t = !1), r ? (n = i = e(n),
            this.bindings = this.bindings.add(n)) : (r = n, n = this.element, i = this.widget()),
            e.each(r, function (r, o) {
                function u() {
                    if (!t && (s.options.disabled === !0
                        || e(this).hasClass("ui-state-disabled"))) return;
                    return (typeof o == "string" ? s[o] : o).apply(s, arguments)
                } typeof o != "string" && (u.guid = o.guid = o.guid || u.guid || e.guid++);
                var a = r.match(/^(\w+)\s*(.*)$/), f = a[1] + s.eventNamespace, l = a[2]; l ? i.delegate(l, f, u)
                : n.bind(f, u)
            })
        }, _off: function (e, t) {
            ...
            this.hoverable = this.hoverable.add(t), this._on(t, {
                mouseenter: function (t) { e(t.currentTarget).addClass("ui-state-hover") }, mouseleave: function (t) {
            ...
            var i, s, o = this.options[t]; r = r || {}, n = e.Event(n),
                n.type = (t === this.widgetEventPrefix ? t : this.widgetEventPrefix + t).toLowerCase(),
            n.target = this.element[0], s = n.originalEvent; if (s) for (i in s) i in n || (n[i] = s[i]);
            return this.element.trigger(n, r), !(e.isFunction(o) && o.apply(this.element[0], [n].concat(r))
                === !1 || n.isDefaultPrevented())
        }
    }, e.each({ show: "fadeIn", hide: "fadeOut" }, function (t, n) {
        e.Widget.prototype["_" + t] = function (r, i, s) {
            typeof i == "string" && (i = { effect: i }); var o, u = i ? i === !0 || typeof i == "number" ?
                n : i.effect || n : t; i = i || {}, typeof i == "number" && (i = { duration: i }), o = !e.isEmptyObject(i),
            i.complete = s, i.delay && r.delay(i.delay), o && e.effects && e.effects.effect[u] ? r[t](i) :
            u !== t && r[u] ? r[u](i.duration, i.easing, s) : r.queue(function (n) { e(this)[t](), s && s.call(r[0]), n() })
        }
    })
}(jQuery); window.OB.RiLi.msg_config = {
    type: {
        fhv: "fake-has-value", fsv: "fake-set-value",
        ftc: "fake-trigger-change", fgv: "fake-get-value", fin: "fake-init", dch: "date-change",
        ctc: "clendar-trigger-change", hin: "hd-init", hgt: "hd-get-tpl", actiondefault: "action-default",
        actionquery: "action-query", actionfestival: "action-festival", actiongoupiao: "action-goupiao"
    }, returnValue: ""
};
...
(function (e, t) {
    "use strict";
    typeof exports != "undefined" ? exports.Mediator = t() : typeof define == "function"
    && define.amd ? define("mediator-js", [], function () { return e.Mediator = t(), e.Mediator() })
    : e.Mediator = t()
})(this, function () {
    "use strict"; function e() {
        var e = function () {
            return ((1 + Math.random())
                * 65536 | 0).toString(16).substring(1)
        }; return e() + e() + "-" + e() + "-" + e() + "-" + e() + "-" + e() + e() + e()
    } function t(n, r, i) {
        if (!(this instanceof t)) return new t(n, r, i); this.id = e(), this.fn = n,
            this.options = r, this.context = i, this.channel = null
    } function n(e, t) {
        if (!(this instanceof n)) return new n(e); this.namespace = e || "",
            this._subscribers = [], this._channels = [], this._parent = t, this.stopped = !1
    } function r() { if (!(this instanceof r)) return new r; this._channels = new n("") } t.prototype = {
        update: function (e) {
            e && (this.fn = e.fn || this.fn, this.context = e.context || this.context,
                this.options = e.options || this.options, this.channel && this.options && this.options.priority
            !== undefined && this.channel.setPriority(this.id, this.options.priority))
        }
    }, n.prototype = {
        addSubscriber: function (e, n, r) {
            var i = new t(e, n, r); return n && n.priority !== undefined ?
                (n.priority = n.priority >> 0, n.priority < 0 && (n.priority = 0), n.priority >= this._subscribers.length &&
                (n.priority = this._subscribers.length - 1), this._subscribers.splice(n.priority, 0, i)) :
                this._subscribers.push(i), i.channel = this, i
        }, stopPropagation: function () { this.stopped = !0 }, getSubscriber: function (e) {
            var t = 0,
                n = this._subscribers.length; for (t, n; t < n; t++) if (this._subscribers[t].id === e
                    || this._subscribers[t].fn === e) return this._subscribers[t]
        }, setPriority: function (e, t) {
            var n = 0, r = 0, i, s, o, u; for (r = 0, u = this._subscribers.length;
                r < u; r++) { if (this._subscribers[r].id === e || this._subscribers[r].fn === e) break; n++ } i = this._subscribers[n], s = this._subscribers.slice(0, n), o = this._subscribers.slice(n + 1), this._subscribers = s.concat(o), this._subscribers.splice(t, 0, i)
        ...
        }, returnChannel: function (e) { return this._channels[e] },
        removeSubscriber: function (e) {
            var t = this._subscribers.length - 1; if (!e) { this._subscribers = []; return } for (t; t >= 0; t--)
                if (this._subscribers[t].fn === e || this._subscribers[t].id === e) this._subscribers[t].channel = null,
                    this._subscribers.splice(t, 1)
        }, publish: function (e) {
            var t = 0, n = this._subscribers.length, r = !1, i, s, o, u;
            for (t, n; t < n; t++) this.stopped || (i = this._subscribers[t], i.options !== undefined &&
                typeof i.options.predicate == "function" ? i.options.predicate.apply(i.context, e) &&
                (i.fn.apply(i.context, e), r = !0) : (o = this._subscribers.length, i.fn.apply(i.context, e),
                u = this._subscribers.length, n = u, u === o - 1 && t--, r = !0)), r && i.options && i.options
                !== undefined && (i.options.calls--, i.options.calls < 1 && (this.removeSubscriber(i.id), n--, t--));
            this._parent && this._parent.publish(e), this.stopped = !1
        }
    }, r.prototype = {
        getChannel: function (e) {
            var t = this._channels, n = e.split(":"), r = 0, i = n.length;
            if (e === "") return t; if (n.length > 0) for (r, i; r < i; r++) t.hasChannel(n[r]) || t.addChannel(n[r]),
                t = t.returnChannel(n[r]); return t
        }, subscribe: function (e, t, n, r) {
            var i = this.getChannel(e); return n = n || {}, r = r || {},
                i.addSubscriber(t, n, r)
        }, once: function (e, t, n, r) { return n = n || {}, n.calls = 1, this.subscribe(e, t, n, r) },
        getSubscriber:
            function (e, t) {
    ...
    }, r.prototype.on = r.prototype.subscribe, r.prototype.bind = r.prototype.subscribe, r.prototype.emit =
        r.prototype.publish, r.prototype.trigger = r.prototype.publish, r.prototype.off = r.prototype.remove,
    r.Channel = n, r.Subscriber = t, r.version = "0.9.5", window.OB.RiLi.mediator = new r
}); (function () {
    function r(e) { this.date = e ? new Date(+e) : G.currDate || new Date } var e, t;
    $.route = function (t, n) {
        t = t || {}; var r; (e || (e = /([\d\w_]+)/g)).lastIndex = 0;
        while ((r = e.exec(n)) !== null) { t = t[r[0]]; if (t == undefined) break } return t
    }, $.format = function () {
        ...
        return e = $.isArray(i) ? i : typeof i == "object" ? e : [e], $.each(e, function (e, i) {
            r.push(n.replace(t || (t = /\{([\d\w\.]+)\}/g), function (t, n, r) {
                return r = n === "INDEX" ?
                    e : n.indexOf(".") < 0 ? i[n] : $.route(i, n), r === undefined ? t : $.isFunction(r) ? r.call(i, n) : r
            }))
        }), r.join("")
    }; var n; $.padWithZero = function (e) { return e.replace(n || (n = /(^|\D)(\d)(?=$|\D)/g), "$10$2") },
    r.prototype = {
        getMonthFirstDate: function () { var e = new Date(+this.date); return e.setDate(1), e },
    ...
    function t(e) { var t = new Date(e); return +t < -0x94e9b950e00 ? null : new n(t) } function n(t) {
        this.oDate = t, this.julianDay = s.fromDate(this.oDate), this.cnDay = this.oDate.getDay() ?
            e.digitCN[this.oDate.getDay()] : "\u65e5"; var n = this.julianDay - s.JD2000, o = i.getTerms(n),
                u = r.getNewMoons(o); t.getFullYear() == "1957" && (u[2].days = 30, u[3].days = 29, u[4].days = 30);
                for (var a = Math.round(n - u[0].JD), f = 0, l; f < u.length; f++) {
                    l = u[f]; if (a < l.days) {
                        this.isBigMonth = l.days == 30, this.isLeap = l.isLeap, this.lMonth = l.name, this.lNextMonth = l.nextName, this.lDate = e.dateCn[a], this.dateIndex = a; break
                    } a -= l.days
                } n = Math.round(n), this.lYear = Math.floor((o[3].JD + (n < o[3].JD ? -365 : 0) + 5844 - 35) / 365.2422 + .5);
                var c = u[u.zyIndex].JD; c -= n < c ? 365 : 0, c += 5810, this.sYear = Math.floor(c / 365.2422 + .5),
                this.hYear = this.sYear + 1984 + 2698; var c = o.hash[n]; this.term = c ? c.name : ""; var c = this.lYear + 6e3;
                this.animal = e.chineseZodiac[c % 12], this.db = e, this.gzYear = e.heavenlyStems[c % 10] +
                    e.earthlyBranches[c % 12]; var c = Math.floor((n - o[0].JD) / 30.43685); c < 12 && n >= o[2 * c + 1].JD
                    && c++, c += Math.floor((o[12].JD + 390) / 365.2422) * 12 + 9e5, this.gzMonth = e.heavenlyStems[c % 10]
                        + e.earthlyBranches[c % 12]; var c = n - 6 + 9e6; this.gzDate = e.heavenlyStems[c % 10] +
                            e.earthlyBranches[c % 12], this.gzChrono = e.earthlyBranches[Math.floor((this.oDate.getHours()
                            + 1) / 2)] || "\u5b50"
    } function h(e) {
        var t = -0.043126 + 628.301955 * e - 2732e-9 * e * e, n = .016708634 - 42037e-9 * e - 1.267e-7 *
            e * e; return -20.49552 * (1 + n * Math.cos(t)) / f
    } function p(e) { return -0.0000034 } function d(e) {
        var t, n, r = e * e, i = 0, s = c;
        for (t = 0; t < s.length; t += 5) t == 0 ? n = -1.742 * e : n = 0, i += (s[t + 3] + n) * Math.sin(s[t]
            + s[t + 1] * e + s[t + 2] * r); return i / 100 / f
    } function v(e) { return g(e / 365.2425 + 2e3) / 86400 } function m(e, t) {
        var n = (e - 1820) / 100;
        return -20 + t * n * n
    } function g(e) {
        var t = l[l.length - 2], n = l[l.length - 1]; if (e >= t) {
            var r = 31; if (e > t + 100)
                return m(e, r); var i = m(e, r), s = m(t, r) - n; return i - s * (t + 100 - e) / 100
        } var o, u = l; for (o = 0; o < u.length; o += 5) if (e < u[o + 5]) break; var a = (e - u[o]) /
            (u[o + 5] - u[o]) * 10, f = a * a, c = f * a; return u[o + 1] + u[o + 2] * a + u[o + 3] * f + u[o + 4] * c
    } function y(e, t, n, r) {
        n /= 10; var i, s, a = 0, l = 1, c, h = u[e], p, d, v, m, g = t * 6 + 1, y = h[g + 1]
            - h[g]; for (i = 0; i < 6; i++, l *= n) {
                p = h[g + i], d = h[g + 1 + i], m = d - p; if (!m) continue;
                r < 0 ? v = d : (v = Math.floor(3 * r * m / y + .5) + p, i && (v += 3), v > d && (v = d));
                for (s = p, c = 0; s < v; s += 3) c += h[s] * Math.cos(h[s + 1] + n * h[s + 2]); a += c * l
            } a /= h[0]; if (e == 0) {
                var b = n * n, w = b * n; t == 0 && (a += (-0.0728 - 2.7702 * n - 1.1019 * b -
                    .0996 * w) / f), t == 1 && (a += (0 + 4e-4 * n + 4e-4 * b - .0026 * w) / f),
                t == 2 && (a += (-0.002 + .0044 * n + .0213 * b - .025 * w) / 1e6)
        } else { var E = o[(e - 1) * 3 + t]; t == 0 && (a += -3 * n / f), t == 2 ? a += E / 1e6 : a += E / f }
        return a
    } function b(e, t, n) {
        var r = a[e], i, s, o, u, l = 0, c = 1, h, p = t * t, d = p * t, v = d * t, m = v * t,
            g = t - 10; e == 0 && (l += (3.81034409 + 8399.684730072 * t - 3319e-8 * p + 3.11e-8 * d - 2.033e-10 * v)
                * f, l += 5028.792262 * t + 1.1124406 * p + 7699e-8 * d - 23479e-9 * v - 1.78e-8 * m, g > 0 &&
            (l += -0.866 + 1.43 * g + .054 * g * g)), p /= 1e4, d /= 1e8, v /= 1e8, n *= 6, n < 0 && (n = r[0].length);
            for (i = 0; i < r.length; i++, c *= t) {
                o = r[i], u = Math.floor(n * o.length / r[0].length + .5), i &&
                    (u += 6), u >= o.length && (u = o.length); for (s = 0, h = 0; s < u; s += 6) h += o[s] * Math.cos(o[s + 1] + t * o[s + 2] + p * o[s + 3] + d * o[s + 4] + v * o[s + 5]); l += h * c
            } return e != 2 && (l /= f), l
    } function E(e) {
        var t = "0000000000", n = t + t, r = {
            J: "00", I: "000", H: "0000", G: "00000", t: "01",
            s: "001", r: "0001", q: "00001", p: "000001", o: "0000001", n: "00000001", m: "000000001", l: "0000000001",
            k: "03", j: "0303", i: "003", h: "003003", g: "0003", f: "00003", e: "000003", d: "0000003", c: "00000003",
            b: "000000003", a: "0000000003", A: n + n + n, B: n + n + t, C: n + n, D: n + t, E: n, F: t
        }; return e.replace(/\D/g, function (e) { return r[e] })
    } function T(e) { return (e < 10 ? "0" : "") + e } var e = {
        digitCN: ["\u96f6", "\u4e00", "\u4e8c", "\u4e09",
            "\u56db", "\u4e94", "\u516d", "\u4e03", "\u516b", "\u4e5d", "\u5341"],
        heavenlyStems: ["\u7532", "\u4e59",
                "\u4e19", "\u4e01", "\u620a", "\u5df1", "\u5e9a", "\u8f9b", "\u58ec", "\u7678"],
        earthlyBranches: ["\u5b50", "\u4e11", "\u5bc5", "\u536f", "\u8fb0", "\u5df3", "\u5348", "\u672a", "\u7533",
            "\u9149", "\u620c", "\u4ea5"], chineseZodiac: ["\u9f20", "\u725b", "\u864e", "\u5154", "\u9f99", "\u86c7",
                "\u9a6c", "\u7f8a", "\u7334", "\u9e21", "\u72d7", "\u732a"], term: ["\u51ac\u81f3", "\u5c0f\u5bd2",
                    "\u5927\u5bd2", "\u7acb\u6625", "\u96e8\u6c34", "\u60ca\u86f0", "\u6625\u5206", "\u6e05\u660e",
                    "\u8c37\u96e8", "\u7acb\u590f", "\u5c0f\u6ee1", "\u8292\u79cd", "\u590f\u81f3", "\u5c0f\u6691",
                    "\u5927\u6691", "\u7acb\u79cb", "\u5904\u6691", "\u767d\u9732", "\u79cb\u5206", "\u5bd2\u9732",
                    "\u971c\u964d", "\u7acb\u51ac", "\u5c0f\u96ea", "\u5927\u96ea"], monthCn: ["\u5341\u4e00", "\u5341\u4e8c",
                        "\u6b63", "\u4e8c", "\u4e09", "\u56db", "\u4e94", "\u516d", "\u4e03", "\u516b", "\u4e5d", "\u5341"],
                    dateCn: ["\u521d\u4e00", "\u521d\u4e8c", "\u521d\u4e09", "\u521d\u56db", "\u521d\u4e94", "\u521d\u516d",
                        "\u521d\u4e03", "\u521d\u516b", "\u521d\u4e5d", "\u521d\u5341", "\u5341\u4e00", "\u5341\u4e8c",
                        "\u5341\u4e09", "\u5341\u56db", "\u5341\u4e94", "\u5341\u516d", "\u5341\u4e03", "\u5341\u516b",
                        "\u5341\u4e5d", "\u4e8c\u5341", "\u5eff\u4e00", "\u5eff\u4e8c", "\u5eff\u4e09", "\u5eff\u56db",
                        "\u5eff\u4e94", "\u5eff\u516d", "\u5eff\u4e03", "\u5eff\u516b", "\u5eff\u4e5d", "\u4e09\u5341",
        ...
        calcForLow: function (e) {
            ...
            return n -= (-0.0000331 * n * n + .10976 * Math.cos(.785 + 8328.6914 * n) + .02224 * Math.cos(.187 + 7214.0629 * n)
                - .03342 * Math.cos(4.669 + 628.3076 * n)) / t + (32 * (n + 1.8) * (n + 1.8) - 20) / 86400 / 36525, n * 36525 + 8 / 24
        }, calcForHigh: function (e) {
            var t = w.MS_aLon_t2(e) * 36525; t = t - v(t) + 8 / 24; var n = (t + .5) % 1 * 86400;
            if (n < 1800 || n > 84600) t = w.MS_aLon_t(e) * 36525 - v(t) + 8 / 24; return t
        }, cache: {}, getNewMoons: function (t) {
            var n = t[0].JD, i = r.calc(n), s = []; i > n && (i -= 29.53);
            if (r.cache[i]) s = r.cache[i]; else {
                for (var o = 0; o < 15; o++) s.push({
                    JD: r.calc(i + 29.5306 * o),
                    index: o
                }), o && (s[o - 1].days = s[o].JD - s[o - 1].JD); if (s[13].JD <= t[24].JD) {
                    for (o = 1; s[o + 1].JD >
                        t[2 * o].JD && o < 13; o++); s[o].isLeap = !0; for (; o < 14; o++) s[o].index--
                } for (o = 0; o < 14; o++) s[o].name = (s[o].isLeap ? "\u95f0" : "") + e.monthCn[s[o].index % 12],
                    s[o].nextName = (s[o + 1].isLeap ? "\u95f0" : "") + e.monthCn[s[o + 1].index % 12], s[o].index == 2
                    && (s.zyIndex = o); r.cache[i] = s
            } return s
        }, calc: function (e) {
            e += s.JD2000; var t, n, r = 14, i = 1947168, o = 2436935; if (e >= o)
                return Math.floor(this.calcForHigh(Math.floor((e + r - 2451551) / 29.5306) * Math.PI * 2) + .5);
            if (e >= i && e < o) return t = Math.floor(this.calcForLow(Math.floor((e + r - 2451551) / 29.5306)
                * Math.PI * 2) + .5), n = this.correction.substr(Math.floor((e - i) / 29.5306), 1) - 0, t + (n ? n - 2 : n)
        }
    }, i = {
...
.091, 1.01, 42062.5561, -1, 23, 0, .09, 6.1, 29342.5781, -5, -32, 0, .09, 4.43, 15542.402, -0.7, 6, 0, .09, 3.8, 15543.1066, -0.7, 6, 0, .089, 4.15, 6063.3859, -2.2, -19, 0, .086, 4.03, 52.9691, 0, 0, 0, .085, .49, 47952.4409, -2.6, 11, 0, .085, 1.6, 7632.8154, 2.1, 32, 0, .084, .22, 14392.0773, -0.7, 6, 0, .083, 6.22, 6028.4466, -4, -41, 0, .083, .63, -7909.9389, 2.8, 26, 0, .083, 5.2, -77.5523, 0, 0, 0, .082, 2.74, 8786.1467, -2.2, -19, 0, .08, 2.43, 9166.5428, -2.8, -26, 0, .08, 3.7, -25405.1732, 4.1, 27, 0, .078, 5.68, 48857.52, 5.4, 106, -1, .077, 1.85, 8315.5735, -2.2, -19, 0, .075, 5.46, -18191.1103, 1.9, 8, 0, .075, 1.41, -16238.6304, 1.3, 1, 0, .074, 5.06, 40110.0761, -0.4, 30, 0, .072, 2.1, 64.4343, -3.7, -44, 0, .071, 2.17, 37671.2695, -3.5, -6, 0, .069, 1.71, 16693.4313, -0.7, 6, 0, .069, 3.33, -26100.7028, -8.3, -119, 1, .068, 1.09, 8329.4028, 1.5, 25, 0, .068, 3.62, 8327.9801, 1.5, 25, 0, .068, 2.41, 16833.1509, -1, 3, 0, .067, 3.4, 24709.2971, -3.5, -20, 0, .067, 1.65, 8346.7156, -0.3, 3, 0, .066, 2.61, 22547.2677, 1.5, 39, 0, .066, 3.5, 15576.5113, -1, 3, 0, .065, 5.76, 33037.9886, -2, 5, 0, .065, 4.58, 8322.1325, -0.3, 3, 0, .065, 6.2, 17913.9868, 3, 50, 0, .065, 1.5, 22685.8295, -1, 9, 0, .065, 2.37, 7180.3058, -1.9, -15, 0, .064, 1.06, 30943.5332, 2.4, 56, 0, .064, 1.89, 8288.8765, 1.5, 25, 0, .064, 4.7, 6.0335, .3, 4, 0, .063, 2.83, 8368.5063, 1.5, 25, 0, .063, 5.66, -2580.7819, .7, 7, 0, .062, 3.78, 7056.3285, -2.2, -19, 0, .061, 1.49, 8294.91, 1.8, 29, 0, .061, .12, -10281.1714, -0.9, -18, 0, .061, 3.06, -8362.4729, -1.2, -21, 0, .061, 4.43, 8170.9571, 1.5, 25, 0, .059, 5.78, -13.1179, -3.7, -44, 0, .059, 5.97, 6625.5702, -2.2, -19, 0, .058, 5.01, -0.508, -0.3, 0, 0, .058, 2.73, 7161.0938, -2.2, -19, 0, .057, .19, 7214.0629, -2.2, -19, 0, .057, 4, 22199.5029, -4.7, -35, 0, .057, 5.38, 8119.142, 5.8, 76, 0, .056, 1.07, 7542.6495, 1.5, 25, 0, .056, .28, 8486.4258, 1.5, 25, 0, .054, 4.19, 16655.0816, 4.6, 75, 0, .053, .72, 7267.032, -2.2, -19, 0, .053, 3.12, 12.6192, .6, 7, 0, .052, 2.99, -32896.013, -1.8, -49, 0, .052, 3.46, 1097.708, 0, 0, 0, .051, 5.37, -6443.786, -1.6, -25, 0, .051, 1.35, 7789.401, -2.2, -19, 0, .051, 5.83, 40042.502, .2, 38, 0, .051, 3.63, 9114.733, 1.5, 25, 0, .05, 1.51, 8504.484, -2.5, -22, 0, .05, 5.23, 16659.684, 1.5, 25, 0, .05, 1.15, 7247.82, -2
.3391, 1.5, 25, 0, 7e-5, 5.85, 8329.0437, 1.5, 25, 0, 6e-5, 1.02, -1742.9305, -3.7, -44, 0, 6e-5, 3.1, 17285.6848, 3, 50, 0, 54e-6, 5.69, -0.352, 0, 0, 0, 43e-6, .52, 15.542, 0, 0, 0, 41e-6, 2.03, 2.63, 0, 0, 0, 4e-5, .1, 8470.667, -2.2, -19, 0, 4e-5, 4.01, 7072.088, 1.6, 25, 0, 36e-6, 2.93, -8.86, -0.3, 0, 0, 3e-5, 1.2, 22128.515, -2.8, -13, 0, 3e-5, 2.54, 15542.754, -0.7, 6, 0, 27e-6, 4.43, 7211.762, -0.7, 6, 0, 26e-6, .51, 15540.453, .9, 31, 0, 26e-6, 1.44, 15545.055, -2.2, -19, 0, 25e-6, 5.37, 7216.364, -3.7, -44, 0], [12e-6, 1.041, -2.3012, 1.52, 25, -0.1, 17e-7, .31, -0.711, 0, 0, 0]]], f = 648e3 / Math.PI, l = new Array(-4e3, 108371.7, -13036.8, 392, 0, -500, 17201, -627.82, 16.17, -0.3413, -150, 12200.6, -346.41, 5.403, -0.1593, 150, 9113.8, -328.13, -1.647, .0377, 500, 5707.5, -391.41, .915, .3145, 900, 2203.4, -283.45, 13.034, -0.1778, 1300, 490.1, -57.35, 2.085, -0.0072, 1600, 120, -9.81, -1.532, .1403, 1700, 10.2, -0.91, .51, -0.037, 1800, 13.4, -0.72, .202, -0.0193, 1830, 7.8, -1.81, .416, -0.0247, 1860, 8.3, -0.13, -0.406, .0292, 1880, -5.4, .32, -0.183, .0173, 1900, -2.3, 2.06, .169, -0.0135, 1920, 21.2, 1.69, -0.304, .0167, 1940, 24.2, 1.22, -0.064, .0031, 1960, 33.2, .51, .231, -0.0109, 1980, 51, 1.29, -0.026, .0032, 2e3, 63.87, .1, 0, 0, 2005, 64.7, .4, 0, 0, 2015, 69), c = new Array(2.1824, -33.75705, 36e-6, -1720, 920, 3.5069, 1256.66393, 11e-6, -132, 57, 1.3375, 16799.4182, -0.000051, -23, 10, 4.3649, -67.5141, 72e-6, 21, -9, .04, -628.302, 0, -14, 0, 2.36, 8328.691, 0, 7, 0, 3.46, 1884.966, 0, -5, 2, 5.44, 16833.175, 0, -4, 2, 3.69, 25128.11, 0, -3, 0, 3.55, 628.362, 0, 2, 0), w = { E_Lon: function (e, t) { return y(0, 0, e, t) }, M_Lon: function (e, t) { return b(0, e, t) }, E_v: function (e) { var t = 628.307585 * e; return 628.332 + 21 * Math.sin(1.527 + t) + .44 * Math.sin(1.48 + t * 2) + .129 * Math.sin(5.82 + t) * e + 55e-5 * Math.sin(4.21 + t) * e * e }, M_v: function (e) { var t = 8399.71 - 914 * Math.sin(.7848 + 8328.691425 * e + 1523e-7 * e * e); return t -= 179 * Math.sin(2.543 + 15542.7543 * e) + 160 * Math.sin(.1874 + 7214.0629 * e) + 62 * Math.sin(3.14 + 16657.3828 * e) + 34 * Math.sin(4.827 + 16866.9323 * e) + 22 * Math.sin(4.9 + 23871.4457 * e) + 12 * Math.sin(2.59 + 14914.4523 * e) + 7 * Math.sin(.23 + 6585.7609 * e) + 5 * Math.sin(.9 + 25195.624 * e) + 5 * Math.sin(2.32 - 7700.3895 * e) + 5 * Math.sin(3.88 + 8956.9934 * e) + 5 * Math.sin(.49 + 7771.3771 * e), t }, MS_aLon: function (e, t, n) { return this.M_Lon(e, t) + p(e) - (this.E_Lon(e, n) + h(e) + Math.PI) }, S_aLon: function (e, t) { return this.E_Lon(e, t) + d(e) + h(e) + Math.PI }, MS_aLon_t: function (e) { var t, n = 7771.37714500204; return t = (e + 1.08472) / n, t += (e - this.MS_aLon(t, 3, 3)) / n, n = this.M_v(t) - this.E_v(t), t += (e - this.MS_aLon(t, 20, 10)) / n, t += (e - this.MS_aLon(t, -1, 60)) / n, t }, S_aLon_t: function (e) { var t, n = 628.3319653318; return t = (e - 1.75347 - Math.PI) / n, n = this.E_v(t), t += (e - this.S_aLon(t, 10)) / n, n = this.E_v(t), t += (e - this.S_aLon(t, -1)) / n, t }, MS_aLon_t2: function (e) { var t, n = 7771.37714500204; t = (e + 1.08472) / n; var r, i = t * t; return t -= (-0.00003309 * i + .10976 * Math.cos(.784758 + 8328.6914246 * t + 152292e-9 * i) + .02224 * Math.cos(.1874 + 7214.0628654 * t - 21848e-8 * i) - .03342 * Math.cos(4.669257 + 628.307585 * t)) / n, r = this.M_Lon(t, 20) - (4.8950632 + 628.3319653318 * t + 5297e-9 * t * t + .0334166 * Math.cos(4.669257 + 628.307585 * t) + 2061e-7 * Math.cos(2.67823 + 628.307585 * t) * t + 349e-6 * Math.cos(4.6261 + 1256.61517 * t) - 20.5 / f), n = 7771.38 - 914 * Math.sin(.7848 + 8328.691425 * t + 1523e-7 * t * t) - 179 * Math.sin(2.543 + 15542.7543 * t) - 160 * Math.sin(.1874 + 7214.0629 * t), t += (e - r) / n, t }, S_aLon_t2: function (e) { var t, n, r = 628.3319653318; return t = (e - 1.75347 - Math.PI) / r, t -= (5297e-9 * t * t + .0334166 * Math.cos(4.669257 + 628.307585 * t) + 2061e-7 * Math.cos(2.67823 + 628.307585 * t) * t) / r, t += (e - this.E_Lon(t, 8) - Math.PI + (20.5 + 17.2 * Math.sin(2.1824 - 33.75705 * t)) / f) / r, t } }; window.OB.RiLi.Lunar = n, window.OB.RiLi.lunar = t; var S = window.OB.RiLi.dateAllFestival, x = {}; x.w = {}, $.each(S, function (e, t) { var n = t.match(/^\w\:(.*)/); if (n !== null) { var r = n[1].split("|"); key = r[0], value = r[1], x.w[key] = value } else { var r = t.split("|"); key = r[0], value = r[1], x[key] = value } }), n.prototype.festival = function () { var e = this.oDate.getFullYear(), t = this.oDate.getMonth() + 1, n = this.oDate.getDate(), r = T(t) + T(n), i = this.oDate.getDay(), s = Math.ceil(n / 7), o = T(t) + s + i, u = this.lMonth, a = this.lDate, f = u + "\u6708" + a, l = []; this.lNextMonth == "\u6b63" && a == (this.isBigMonth ? "\u4e09\u5341" : "\u5eff\u4e5d") && l.push("v,\u9664\u5915"), x.w[o] && (l = l.concat(x.w[o].split("|"))), x[f] && (l = l.concat(x[f].split("|"))), x[r] && (l = l.concat(x[r].split("|"))); for (var c, h = l.length - 1; h > -1; h--) { c = l[h].split(","); if (c[2] && e < c[2] - 0) { l.splice(h, 1); continue } l[h] = { type: c[0], desc: c[1] } } return l.sort(function (e, t) { return t.type.charCodeAt(0) - e.type.charCodeAt(0) }) }
    ...
    }(), function () { var e = {}, t = "ns"; e.localStorage = { test: function () { try { return window.localStorage ? !0 : !1 } catch (e) { return !1 } }, methods: { init: function (e) { }, set: function (e, t, n) { try { localStorage.setItem(e + t, n) } catch (r) { throw r } }, get: function (e, t) { return localStorage.getItem(e + t) }, remove: function (e, t) { localStorage.removeItem(e + t) }, clear: function (e) { if (!e) localStorage.clear(); else for (var t = localStorage.length - 1, n; n = localStorage.key(t--) ;) n && n.indexOf(e) === 0 && localStorage.removeItem(n) } } }, e.userData = { test: function () { try { return window.ActiveXObject && document.documentElement.addBehavior ? !0 : !1 } catch (e) { return !1 } }, methods: { _owners: {}, init: function (e) { if (!this._owners[e]) { if (document.getElementById(e)) this._owners[e] = document.getElementById(e); else { var t = document.createElement("script"), n = document.head || document.getElementsByTagName("head")[0] || document.documentElement; t.id = e, t.style.display = "none", t.addBehavior("#default#userdata"), n.insertBefore(t, n.firstChild), this._owners[e] = t } try { this._owners[e].load(e) } catch (r) { } var i = this; window.attachEvent("onunload", function () { i._owners[e] = null }) } }, set: function (e, t, n) { if (this._owners[e]) try { this._owners[e].setAttribute(t, n), this._owners[e].save(e) } catch (r) { throw r } }, get: function (e, t) { return this._owners[e] ? (this._owners[e].load(e), this._owners[e].getAttribute(t) || "") : "" }, remove: function (e, t) { this._owners[e] && (this._owners[e].removeAttribute(t), this._owners[e].save(e)) }, clear: function (e) { if (this._owners[e]) { var t = this._owners[e].XMLDocument.documentElement.attributes; this._owners[e].load(e); for (var n = 0, r; r = t[n]; n++) this._owners[e].removeAttribute(r.name); this._owners[e].save(e) } } } }; var n = function () { return e.localStorage.test() ? e.localStorage.methods : e.userData.test() ? e.userData.methods : { init: function () { }, get: function () { }, set: function () { }, remove: function () { }, clear: function () { } } }(), r = {}, i = function (e, r) { this._ns = t + "_" + e + "_", this._inited = !1, this.storeSvc = r ? { init: function (e) { r[e] = {} }, get: function (e, t) { return r[e][t] }, set: function (e, t, n) { r[e][t] = n }, remove: function (e, t) { delete r[e][t] }, clear: function (e) { delete r[e] } } : n, this._obj = r, this.storeSvc && !this._inited && this.storeSvc.init(this._ns) }; i.serialize = function (e) { return JSON.stringify(e) }, i.unserialize = function (e) { return JSON.parse(e) }, i.prototype = { set: function (e, t) { try { return this.storeSvc.set(this._ns, e, i.serialize(t)), !0 } catch (n) { return !1 } }, get: function (e) { try { return i.unserialize(this.storeSvc.get(this._ns, e)) } catch (t) { } }, remove: function (e) { try { this.storeSvc.remove(this._ns, e) } catch (t) { } }, clear: function () { try { this.storeSvc.clear(this._ns) } catch (e) { } } }, i.ins = function (e, t) { if (!r[e] || r[e]._obj != t) r[e] = new i(e, t); return r[e] }, window.OB.RiLi.CacheSVC = i }()
})(); (function () { function t(t, n, r) { this.storage = e.ins(t, r), this.signature = n, this.lastUpdate = null, this.dataFormatter = { getter: null, setter: null } } var e = window.OB.RiLi.CacheSVC; t.clear = function (t) { e.ins(t).clear() }, t.prototype = { setFormatter: function (e, t) { this.dataFormatter = { setter: e, getter: t } }, set: function (e, t, n) { this.dataFormatter && this.dataFormatter.setter && (t = this.dataFormatter.setter(t)), this.lastUpdate = (new Date).getTime(); var r = { value: t, signature: this.signature, lastUpdate: this.lastUpdate }; n && (r.expires = n), this.storage.set(e, r) }, get: function (e, t) { var n = this.storage.get(e); if (n && n.signature === this.signature && (t || !n.expires || (new Date).getTime() < n.expires)) return n = n.value, this.dataFormatter && this.dataFormatter.getter && (n = this.dataFormatter.getter(n)), n }, remove: function (e) { this.storage.remove(e) }, clear: function () { this.storage.clear() }, getUpdatedTime: function (e) { var t = this.storage.get(e); return t && t.lastUpdate - 0 }, getExpires: function (e) { var t = this.storage.get(e); return t && t.expires } }, window.OB.RiLi.AppData = t })(); (function () { function a(n) { o && clearInterval(o), u(e, function (e) { e || (e = (new Date).getTime()), r = (new Date(e)).getTime(), s = i = (new Date).getTime(), f(n), o = setInterval(function () { f(null) }, t) }) } function f(e) { var o = (new Date).getTime(); !s || Math.abs(o - s) > t * 3 ? a(e) : (s = o, Math.abs(r - i) > n && (o = r - i + o)), e && e(new Date(o)) } $.ajaxSetup({ cache: !0 }); var e = "http://hao.360.cn/time.php", t = 6e4, n = 3e5; location.protocol == "https:" && (e = "https://open.onebox.haosou.com/api/proxy?__url__=" + encodeURIComponent(e)); var r = null, i = null, s = null, o = null, u = function (e, n) { window.callback = n, e = e + "?t=" + Math.floor(+(new Date) / t), $.getScript(e) }, l = { getTime: f }; window.OB.RiLi.TimeSVC = l })(); (function () { var e = window.OB.RiLi, t = e.useLunarTicketDay, n = e.lunar, r = e.dateHuochepiao, i = [], s = {}, o = function (e) { return e < 10 ? "0" + e + "" : e + "" }, u = "<span class='mh-ticket {cls}'>\u7968{monthday}</span>", a = "<span class='red'>\u53ef\u9884\u8ba2{month}\u6708{day}\u65e5\u8f66\u7968</span>", f = "<em class='mh-lunar-ticket'>\u519c\u5386{l}</em>", l = function (e, t) { var n = e.substr(0, 4), r = e.substr(4, 2), i = e.substr(6, 2), s = new Date([n, r, i].join("/")); t != 0 && (s = t < 0 ? new Date(+s - 864e5) : new Date(+s + 864e5)); var u = o(s.getMonth() + 1), a = o(s.getDate()); return [s.getFullYear(), u, a].join("/") }; for (var c = 0; c < r.length; ++c) { var h = r[c]; lineInfo = h.split("||"); if (/^-\d{8}$/.test(lineInfo[0])) { i.push({ date: l(lineInfo[0].substr(1, 8), -1), delta: lineInfo[1], cmd: "<" }); continue } if (/^\d{8}$/.test(lineInfo[0])) { i.push({ date: l(lineInfo[0], 0), delta: lineInfo[1], cmd: "=" }); continue } if (/^\+\d{8}$/.test(lineInfo[0])) { i.push({ date: l(lineInfo[0].substr(1, 8), 1), delta: lineInfo[1], cmd: ">" }); continue } if (/^c\d{8}-\d{8}$/.test(lineInfo[0])) { var p = lineInfo[0].replace("c", "").split("-"); s.min = l(p[0], 0), s.max = l(p[1], 0), s.color = lineInfo[1] } } e.Huochepiao = { getHuochepiaoDay: function (e, t, n) { var r, u = {}, a = o(t), f = o(n), l = [e, a, f].join("/"), c; for (var h = 0; h < i.length; ++h) { r = i[h]; if (r.cmd == "<" && l <= r.date || r.cmd == "=" && l == r.date || r.cmd == ">" && l >= r.date) { c = +(new Date([e, t, n].join("/"))) + (r.delta - 1) * 864e5, u.piaodate = new Date(c); break } } return s.min <= l && s.max >= l && (u.color = s.color), u }, getHuochepiaoDayHtml: function (n, r, i) { var s = this.getHuochepiaoDay(n, r, i), a = s["color"] == "red" ? "mh-hotticket" : "", f = o(s.piaodate.getMonth() + 1), l = o(s.piaodate.getDate()), c = [n, o(r), o(i)].join("/"), h = [e.today.getFullYear(), o(e.today.getMonth() + 1), o(e.today.getDate())].join("/"), p = s.piaodate.getFullYear(); if (c >= h) { var d = [f, l].join(""), v = t[p] && t[p][d] ? " " + t[p][d] : f + "." + l; return $.format(u, { cls: a, monthday: v }) } return "" }, getHuochepiaoDayGongli: function (e, t, n) { var r = this.getHuochepiaoDay(e, t, n); return $.format(a, { month: o(r.piaodate.getMonth() + 1), day: o(r.piaodate.getDate()) }) }, getHuochepiaoDayGongliProxy: function (e, t, n) { var r = this.getHuochepiaoDay(e, t, n), i = new Date(r.piaodate - 1728e5); return $.format(a, { month: o(i.getMonth() + 1), day: o(i.getDate()) }) }, getHuochepiaoDayNongli: function (e, t, r) { var i = this.getHuochepiaoDay(e, t, r), s = n(i.piaodate), o = s.lMonth.replace("\u5341\u4e8c", "\u814a") + "\u6708" + s.lDate; return $.format(f, { l: o }) }, getHuochepiaoDayNongliProxy: function (e, t, r) { var i = this.getHuochepiaoDay(e, t, r), s = new Date(i.piaodate - 1728e5), o = n(s), u = o.lMonth + "\u6708" + o.lDate; return $.format(f, { l: u }) } } })(); (function () {
    $.widget("rili.fakeSelect", {
        options: { data: [], onchange: $.noop, value: "", circle: !1 }, _create: function () {
            var e = this, t = $(this.element), n = this.options; this.name = n.name, this.prev = t.find(".mh-prev"), this.next = t.find(".mh-next"), this.cont = t.find("div.mh-control"), this.header = t.find(".mh-field"), this.list = t.find(".mh-list"), this.cont.find(".mh-holiday").length > 0 ? this.list.html($.format('<li val="{value}" is_sel={is_sel}>{text}</li>', n.data)) : this.list.html($.format('<li val="{value}">{text}</li>', n.data)), this.opts = this.list.find("li"), this.cont.click(function () { e.list.toggle(); if (e.list.is(":visible")) { var t = e.header.attr("val") || "", n = e.opts.removeClass("mh-on").filter('[val="' + t + '"]').addClass("mh-on"); n.size() && e.list.scrollTop(n.prop("offsetTop") - 42) } }),
            this.opts.mouseenter(function () {
                e.opts.removeClass("mh-on"),
                    $(this).addClass("mh-on")
            }).click(function (t) {
                //年、月切换操作实现
                e.list.hide();
                ...
                var optionMonth = encodeURI(s).indexOf("%E5%B9%B4") != -1 ? $(".mh-month").attr("val") : i;
                optionMonth = (optionMonth.length < 2 ? ("0" + optionMonth) : optionMonth);

                //console.log("切换时间:" + $(".mh-year").text() + "-" + optionMonth);
                var optionYear = encodeURI(s).indexOf("%E5%B9%B4") != -1 ? i : $(".mh-year").attr("val");
                $("#mh-date-y").text(optionYear);
                $.ajax({
                    url: "/LoanManage/Calendar/GetRepayTaskCalendar?time=" + (optionYear + "-" + optionMonth) + "&isToday=false",
                    dataType: "json",
                    async: false,
                    success: function (data) {
                        window.OB.RiLi.dateRest = data.overdueCalendar;//逾期
                        window.OB.RiLi.dateWork = data.repayCalendar;//还款日
                        o != i && (e.header.html(s).attr("val", i), i && n.onchange.call(e, i, o))
                    }
                });
            }),
            this.prev.size() &&
            this.prev.add(this.next).click(function (t) {
                //年、月切换计算
                t.preventDefault();
                var n = $(this), r = e.header.attr("val") || "", i = e.opts.filter('[val="' + r + '"]');
                i.size() && (i = i[n.attr("action")](),
                !i.size() && $(this).siblings(".mh-control").find(".mh-field").hasClass("mh-month")
                && ("prev" == n.attr("action") ? (i = $(e.opts[e.opts.length - 1]),
                $(".mh-control .mh-year").parent(".mh-control").siblings(".mh-prev").triggerHandler("click"))
                : (i = $(e.opts[0]), $(".mh-control .mh-year").parent(".mh-control").siblings(".mh-next").triggerHandler("click"))),
                i.size() && i.triggerHandler("click"))

            });
            var r = e.opts.filter('[val="' + n.value + '"]'); e.header.html(r.text()).attr("val", r.attr("val")),
            this.cont.find(".mh-holiday").length > 0 && (r = e.opts.filter('[is_sel="true"]'),
            r.length && e.header.html(r.text()).attr("val", r.attr("val"))),
            $("body").click(function (t) {
                e.cont.find(t.target).size() || e.list.hide()
            })
        }, hasValue: function (e) { var t = this, n = $(this.element), r = this.options, i = t.opts.filter('[val="' + e + '"]'); return i.size() ? i : null }, setValue: function (e) { var t = this, n = $(this.element), r = this.options, i = this.hasValue(e); if (i) this.header.attr("val", e).text(i.text()); else { var s = window.OB.RiLi.rootSelector || ""; this.header.attr("val", "").text($(s + "#mh-date-y").html() + "\u5e74\u5047\u65e5\u5b89\u6392") } }, getValue: function () { return this.header.attr("val") }, triggerChange: function () { this.options.onchange.call(this, this.header.attr("val"), "") }
    })
})(); (function () {
    $.widget("rili.speCalendar", {
        options: {},
        _create: function () {
            var e = this.element; e.delegate("li.mh-spe-item", "mouseenter", function () {
                var e = $(this), t = e.find(".mh-spe-cover"); t.show()
            }), e.delegate("li.mh-spe-item", "mouseleave", function () {
                var e = $(this), t = e.find(".mh-spe-cover"); t.hide()
            })
        }, getTpl: function (e) {
            var t = this, n = e[0], r = e[1], i = e[2];
            return this.tpl = [],
                this.tpl.push('<li class="mh-spe-item {monthClass}" date="{date}"><span class="mh-border"></span>'),
                this.tpl.push('<div class="mh-solar">{solar}</div><span class="mh-lunar">{lunar}</span>'),
                this.tpl.push('<span class="mh-spe-des">{speDes}</span>'),
                this.tpl.push('<div class="mh-spe-cover"><a href="{speUrl}"><img src="{speImg}"/><span class="mh-spe-cover-des">{speDes}</span></a></div>'),
                this.tpl.push("</li>"), this.tpl = this.tpl.join(""),
                this.tpl = $.format(t.tpl, { speDes: n, speUrl: r, speImg: i }),
                this.tpl
        }
    })
})(); (function () {
    var e = window.OB.RiLi, t = e.msg_config, n = e.Huochepiao, r = e.mediator, i = e.lunar,
        s = e.Lunar, o = e.rootSelector || "", u = $.trim($(o + "#mh-date-y").html()),
        a = e.dateFestival, f = [], l, c, l, c; $.route = function (e, t) {
            e = e || {};
            var n; (l || (l = /([\d\w_]+)/g)).lastIndex = 0;
            while ((n = l.exec(t)) !== null) { e = e[n[0]]; if (e == undefined) break } return e
        },
    $.format = function () {
        ...
        return e = $.isArray(r) ? r : typeof r == "object" ? e : [e], $.each(e, function (e, r) {
            n.push(t.replace(c || (c = /\{([\d\w\.]+)\}/g), function (t, n, i) {
                return i = n === "INDEX" ? e : n.indexOf(".") < 0 ? r[n] : $.route(r, n),
                    i === undefined ? t : $.isFunction(i) ? i.call(r, n) : i
            }))
        }), n.join("")
    };
        var h; $.padWithZero = function (e) {
            return e.replace(h || (h = /(^|\D)(\d)(?=$|\D)/g), "$10$2")
        }, $.each(a, function (e, t) {
            var n = t.split("||"); n[0] == "20140201" && (n[0] = "20140131"), f.push(n[0])
        }), $.widget("rili.webCalendar", {
            options: { onselect: $.noop }, _create: function () {
                var e = this, t = $(this.element);
                this.panel = t.find("ol.mh-dates-bd"),
                this.tmplDate = '<li class="{monthClass}" date="{date}" data-md=\'{"p":"day-box"}\'><span class="mh-border">'+
                    '</span><div class="mh-solar">{solar}</div><span class="mh-lunar" {lunarTitle} >{lunar}</span>{goupiao}</li>',
                this.initTime(this.options.time), this.handleClick(), this.initDatePicker()
            },
            _showCurrentTime: function () {
                var t = this, n = $(this.element), r = this.options; this.timeContainer = n.find(".mh-time-monitor");
                var i = function () {
                    var n = new Date; if (e.today) {
            ...
            initTime: function (n) {
                ...
                this.now = new Date, this.today = e.today, this.initCalendar(u, a),
                this.options.onselect.call(s, o, i(o)), this._showCurrentTime(), r.publish(t.type.ctc, { data: o })
            },
            initCalendar: function (s, o, a) {
                var l = this, c = $(this.element), h = this.options, p = new Date(s, o - 1, a || 1),
                    d = new window.OB.RiLi.Calendar(p), v = d.getCalendarFirstDate(), m = this.today;
                this.year = p.getFullYear(), this.month = p.getMonth() + 1, e.action == "goupiao"
                && $(".mh-dates").addClass("mh-goupiao-dates");
                var g = {}, y = {}, b = {}, w = e.dateRest;
                $.each(w, function (e, t) {
                    g[t] = "mh-rest"
                });
                var E = e.dateWork; $.each(E, function (e, t) { y[t] = "mh-work" });
                var S = new Date(v),
                    x = $.map(new Array(42),
                    function (s, a) {
                        u = $("#mh-date-y").text();
                    var c = S.getFullYear(), h = S.getMonth(), p = S.getDate(), d = S.getDay(), v = i(S), w = [],
                        E = ("0" + (h + 1)).slice(-2) + ("0" + p).slice(-2), x = c + E + "";
                    $.inArray(x, f) != -1 && w.push("mh-fes"), h != o - 1 && w.push("mh-cross-month"),
                    (a + 1) % 7 == 0 && w.push("mh-last"), p == m.getDate() && h == m.getMonth() && c == m.getFullYear()
                    && w.push("mh-today"), (d == 0 || d == 6) && w.push("mh-weekend"); var T = v.festival();

                        v.term ? w.push("mh-solar-style") :
                            T.length && w.push("mh-" + T[0].type + "solar-style"),
                        c == u &&
                        (g[E] && w.push(g[E], "mh-vacation"),
                        y[E] && w.push(y[E]));

                    if (b[u + E]) {
                        r.publish(t.type.hgt, { data: b[u + E] }); var N = t.returnValue
                    }
                    else {
                        var N = l.tmplDate;
                        S.setDate(S.getDate() + 1), e.action == "goupiao" ? goupiao = n.getHuochepiaoDayHtml(c, h + 1, p)
                        : goupiao = "";
                        var C, k;
                    }

                    return C = T[0] && T[0].desc.length < 9 && T[0].desc || v.term || v.dateIndex == 0
                        && v.lMonth + "\u6708" + (v.isBigMonth ? "\u5927" : "\u5c0f") || v.lDate, C.length > 4 ?
                        $.format(N, {
                            monthClass: w.join(" "), solar: p, lunar: C, date: [c, h + 1, p].join("/"),
                            goupiao: goupiao, lunarTitle: "title='" + C + "'"
                        }) : $.format(N, {
                            monthClass: w.join(" "), solar: p, lunar: C,
                            date: [c, h + 1, p].join("/"), goupiao: goupiao, lunarTitle: ""
                        })
                });
                this.panel.html(x)
            },
            ...
            $(n.panel).delegate("li", "click", function () {
                n.panel.find("li.mh-on").removeClass("mh-on"),
                n.panel.find("li.reston").removeClass("reston").addClass("mh-rest"),
                n.panel.find("li.workon").removeClass("workon").addClass("mh-work");
                var s = $(this).addClass("mh-on"),
                    u = s.attr("date"), a = new Date(u), f = a.getFullYear(), l = a.getMonth() + 1,
                    c = null; r.publish(t.type.fhv, { data: f, from: n.dltYear }), c = t.returnValue,
                l == n.month && f == n.year || !c ? (o.onselect.call(n, a, i(a)),
                r.publish(t.type.ctc, { data: a }), typeof e.CallBack.holiday == "function"
                && e.CallBack.holiday(
                        $.trim(n.panel.find('li[date="' + u + '"]').find(".mh-lunar").html())
                        , n.year)
                ) :
                (r.publish(t.type.fsv, { data: f, from: n.dltYear }),
                r.publish(t.type.fsv, { data: l, from: n.dltMonth }), r.publish(t.type.ftc, { data: {}, from: n.dltMonth }),
                n.panel.find('li[date="' + u + '"]').click())

                var className =$(this).attr("class");
                if (className.indexOf("mh-work") != -1 || className.indexOf("mh-rest") != -1) {
                    //日历天单击事件
                    $.ajax({
                        url: "/LoanManage/Calendar/GetCalendarByToday?time=" + $(this).attr("date"),
                        dataType: "json",
                        async: false,
                        success: function (data) {
                            var htmlR = "";
                            for (var i = 0; i < data.length; i++) {
                                var item = data[i];
                                htmlR += '<tr class="jqgrow ui-row-ltr">';
                                htmlR += '<td style="text-align:center;">' + item.LoanMain + '</td>';
                                htmlR += '<td style="text-align:center;">' + item.TotalAmount + '</td>';
                                htmlR += '<td style="text-align:center;">' + item.CapitalAmount + '</td>';
                                htmlR += '<td style="text-align:center;">' + item.InterestAmount + '</td>';
                                htmlR += '<td style="text-align:center;">' + item.OtherAmount + '</td>';
                                htmlR += '<td style="text-align:center;">' + (item.Term + '/' + item.SumTerm) + '</td>';
                                htmlR += '<td style="text-align:center;">' + (item.RePayState == 2 ? '<img src="/Content/img/calendarOverduer.png" />' : '<img src="/Content/img/calendarRepay.png" />') + '</td>';
                                htmlR += '</tr>';
                            }
                            $(".CalendarRepayTaskMain").html(htmlR);

                        }
                    });
                } else { $(".CalendarRepayTaskMain").html('<tr><th colspan="7">No Data~</th></tr>'); }
            })
        }, initDatePicker: function () {
            var n = this, i = $(this.element), s = this.options, o = function (e) {
                var i, s; this.name == "year" ? (i = e, r.publish(t.type.fgv,
                    { data: {}, from: n.dltMonth }), s = t.returnValue, e += ("0" + s).slice(-2)) :
                (r.publish(t.type.fgv, { data: {}, from: n.dltYear }), i = t.returnValue, s = e,
                e = i + ("0" + s).slice(-2)), n.initCalendar(i, s),
                r.publish(t.type.fsv, { data: e, from: n.dltFestival })
            }, f = function (i) {
                var s = i.slice(0, 4) - 0, o = i.slice(4, 6) - 0, u = i.slice(-2) - 0;
                n.initCalendar(s, o, u); var f = a, l = [], c = s < 10 ? "0" + s + "" : s + "",
                    h = o < 10 ? "0" + o + "" : o + "", p = u < 10 ? "0" + u + "" : u + "", d = "";
                r.publish(t.type.fsv, { data: s, from: n.dltYear }), r.publish(t.type.fsv, { data: o, from: n.dltMonth });
                for (var v = 0; v < f.length; ++v) {
                    l = $.trim(f[v]).split("||"); if (l[0].slice(0, 8) == c + h + p) {
                        d = s + "/" + o + "/" +
                            (l[0].slice(-2) - 0) + "", d != "2014/2/1" ? $("li[date='" + d + "']").click()
                        : typeof e.CallBack.holiday == "function" && e.CallBack.holiday("\u6625\u8282", s);
                        break
                    }
                }
            };
            this.dltYear = i.find("div.mh-year-bar"), this.dltMonth = i.find("div.mh-mouth-bar"),
            this.dltFestival = i.find("div.mh-holiday-bar"); var l = []; l.push({
                value: "",
                text: u + "\u5e74\u5047\u65e5\u5b89\u6392"
            }); var c = e.needDay || e.today, h = c.getMonth() + 1, p = c.getDate();
            h = h > 9 ? h : "0" + h + "", $.each(a, function (e, t) {
                var n = {}, r = t.split("||"),
                    i = r[0].substr(0, 8), s = r[1]; n.value = i, n.text = s, i.substr(0, 8) == c.getFullYear() + h + p ?
                n.is_sel = !0 : n.is_sel = !1, l.push(n)
            }),
            setTimeout(function () {
                var i = e.needDay || e.today; r.publish(t.type.fin, {
                    data: {
                        name: "year", value: i.getFullYear(), onchange: o, data: $.map(new Array(200),
                            function (e, t) { var n = 1901 + t; return { value: n, text: n + "\u5e74" } })
                    }, from: n.dltYear
                })
            }, 200),
            setTimeout(function () {
                r.publish(t.type.fin, {
                    data: {
                        name: "month", value: c.getMonth() + 1,
                        onchange: o, circle: !0, data: $.map(new Array(12), function (e, t) {
                            var n = t + 1;
                            return {
                                value: n, text: n + "\u6708"
                            }
            ...
            setTimeout(function () {
                ...
                this.btnToday = i.find(".mh-btn-today").click(function (e) {

                    var optionYear = n.today.getFullYear();
                    var optionMonth = n.today.getMonth() + 1;
                    $("#mh-date-y").text(optionYear);

                    $.ajax({
                        url: "/LoanManage/Calendar/GetRepayTaskCalendar?time=" + (optionYear + "-" + optionMonth) + "&isToday=true",
                        dataType: "json",
                        async: false,
                        success: function (data) {
                            window.OB.RiLi.dateRest = data.overdueCalendar;//逾期
                            ...
                            //返回今天
                            e.preventDefault(),
                            r.publish(t.type.fsv, { data: n.today.getFullYear(), from: n.dltYear }),
                            r.publish(t.type.fsv, { data: n.today.getMonth() + 1, from: n.dltMonth }),
    ...
    var e = {
        getAstroByDate: function (e, t) {
            var n = "\u9b54\u7faf\u6c34\u74f6\u53cc\u9c7c\u7261\u7f8a\u91d1\u725b\u53cc\u5b50\u5de8\u87f9\u72ee\u5b50"
            + "\u5904\u5973\u5929\u79e4\u5929\u874e\u5c04\u624b\u9b54\u7faf",
            r = [20, 19, 21, 21, 21, 22, 23, 23, 23, 23, 22, 22];
            return n.substr(e * 2 - (t < r[e - 1] ? 2 : 0), 2) + "\u5ea7"
        }
    }, t = window.OB.RiLi.Huochepiao; $.widget("rili.dayDetail", {
        options: {}, _create: function () {
            var e = this, t = $(this.element), n = this.options;
            this.tmpl = [], this.tmpl.push('<div class="mh-dates-bar">'),
            this.tmpl.push('<span class="mh-date">{year}-{padmonth}-{paddate}</span>'),
            this.tmpl.push('<span class="mh-weekday">{week}</span>'), this.tmpl.push("</div>"),
            this.tmpl.push('<div class="mh-date-show-panel">'), this.tmpl.push("{date}"),
            this.tmpl.push("</div>"), this.tmpl.push('<div class="mh-desc">'),
            this.tmpl.push('<div class="mh-lunar">\u519c\u5386{lmonth}\u6708{ldate}</div>'),
            this.tmpl.push('<div class="mh-lunar-ganzhi">'), this.tmpl.push("{gzyear}\u5e74{gzmonth}\u6708{gzdate}\u65e5"),
            this.tmpl.push("</div>"), this.tmpl.push('<div class="mh-other-info">'),
            this.tmpl.push('<span class="mh-animal-year">[<em class="mh-animal">{animal}\u5e74</em>]</span>'),
            this.tmpl.push('<span class="mh-astro">{astro}</span>'), this.tmpl.push("</div>"),
            this.tmpl.push('<div class="mh-lunar-term">'), this.tmpl.push("{festival}"), this.tmpl.push("</div>"),
            this.tmpl.push("</div>"), this.tmpl = this.tmpl.join("")
        }, init: function (n, r) {
            var i = this, s = $(this.element), o = this.options, u = n.getFullYear(),
                a = n.getMonth() + 1, f = n.getDate(), l = new Date, c = r.festival();
            s.html($.format(this.tmpl, {
                year: u, padmonth: ("0" + a).slice(-2),
                paddate: ("0" + f).slice(-2), date: f, week: "\u661f\u671f" + r.cnDay, animal: r.animal,
                ...
                lmonth: r.lMonth, ldate: r.lDate, nofestival: c.length || r.term ? "" : " nofestival",
                festival: c.length && $.trim($.format("{desc} ", c)) || r.term || "", gzyear: r.gzYear,
                gzmonth: r.gzMonth, gzdate: r.gzDate, astro: e.getAstroByDate(("0" + a).slice(-2), f)
            })),
            window.OB.RiLi.action != "goupiao" ? (this.loadLuckyData(u, a, f), $(".mh-almanac-extra").show(),
            $(".mh-linktail").show()) : ($(".mh-linktail-goupiao").show(),
            $(".mh-phone-net .mh-gongli").html(t.getHuochepiaoDayGongli(u, a, f)),
            $(".mh-proxy .mh-gongli").html(t.getHuochepiaoDayGongliProxy(u, a, f)),
            $(".mh-phone-net .mh-nongli").html(t.getHuochepiaoDayNongli(u, a, f)),
            $(".mh-proxy .mh-nongli").html(t.getHuochepiaoDayNongliProxy(u, a, f)),
            $(".mh-almanac").addClass("mh-almanac-goupiao"), $(".mh-ticket-info").show())
        }, loadLuckyData: function (e, t, n) {
            var r = this, i = $(this.element), s = this.options, o = "d" + ("0" + t).slice(-2) +
                ("0" + n).slice(-2), u = window.OB.RiLi.HuangLi; u && u["y" + e] ?
            this.fillLuckyData(u["y" + e][o]) : e > 2007 && e < 2021 ? (clearTimeout(window.OB.RiLi.getHandle),
            window.OB.RiLi.getHandle = setTimeout(function () {
            ...
            function t(e) {
                ...
                return e.sort(function (e, t) {
                    ...
                    r.length > 3 ? t.push(s) : n % 2 == 1 ? t.push(i) : n == e.length - 1 ? t.push(s)
                    : e[n + 1].length > 3 ? t.push(s) : t.push(i); if (t.length > 8) return !1
                }), t.slice(0, 8).join("")
            } var n = this, r = $(this.element), i = this.options, s = e.y.replace(/^\.|\.$/g, "").split("."),
                o = e.j.replace(/^\.|\.$/g, "").split("."); $(".mh-suited .mh-st-items").html(t(s)).attr("title",
                    s.join(" ")), $(".mh-tapu .mh-st-items").html(t(o)).attr("title", o.join(" "))
        }
    })
})(); (function () {
    var e = window.OB.RiLi.mediator, t = window.OB.RiLi.msg_config, n = $(".mh-calendar");
    e.subscribe(t.type.fsv, function (e) { e.from.fakeSelect("setValue", e.data) }),
    e.subscribe(t.type.ftc, function (e) { e.from.fakeSelect("triggerChange") }),
    e.subscribe(t.type.fhv, function (e) { t.returnValue = e.from.fakeSelect("hasValue", e.data) }),
    e.subscribe(t.type.fgv, function (e) { t.returnValue = e.from.fakeSelect("getValue") }),
    e.subscribe(t.type.fin, function (e) { e.from.fakeSelect(e.data) }), e.subscribe(t.type.hin, function (e) {
        n.speCalendar()
    }), e.subscribe(t.type.hgt, function (e) { t.returnValue = n.speCalendar("getTpl", e.data) })
})(); (function () {
    var e = window.OB.RiLi.msg_config, t = window.OB.RiLi.mediator, n = function () {
        var e = {}, t = $("#mh-rili-params").val() || ""; if (t) {
            var n = t.replace(/^\?/, "").split("&"), r; for (var i = 0; i < n.length; ++i)
                r = n[i].split("="), e[r[0]] = r[1]
        } return e
    }; window.OB.RiLi.Dispatcher = {
        dispatch: function () {
            var r = n(); switch (r.action) {
                case "query": t.publish(e.type.actionquery, r);
                    break;
                case "goupiao": t.publish(e.type.actiongoupiao, r);
                    break;
                case "festival": t.publish(e.type.actionfestival, r);
                    break;
                default: t.publish(e.type.actiondefault, r)
            }
        }
    }
})();