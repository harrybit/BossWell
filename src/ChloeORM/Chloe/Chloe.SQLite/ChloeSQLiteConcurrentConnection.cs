...
namespace Chloe.SQLite
{
    ...
    internal class ChloeSQLiteConcurrentConnection : IDbConnection, IDisposable
    {
        private IDbConnection _dbConnection;
        private ReaderWriterLockWrapper _rwLock;

        private static readonly Dictionary<string, ReaderWriterLockSlim> _RWLocks = new Dictionary<string, ReaderWriterLockSlim>();
        ...
        private static ReaderWriterLockSlim GetReaderWriterLock(string connString)
        {
