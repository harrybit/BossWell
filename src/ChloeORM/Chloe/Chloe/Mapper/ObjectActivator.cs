...
namespace Chloe.Mapper
{
    ...
    {
        private int? _checkNullOrdinal;
        private Func<IDataReader, ReaderOrdinalEnumerator, ObjectActivatorEnumerator, object> _instanceCreator;
        private List<int> _readerOrdinals;
        private List<IObjectActivator> _objectActivators;
        private List<IValueSetter> _memberSetters;

        private ReaderOrdinalEnumerator _readerOrdinalEnumerator;
        private ObjectActivatorEnumerator _objectActivatorEnumerator;
